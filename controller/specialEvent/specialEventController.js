...
/**
 * Get Special Event Data for Fixed Plan
 * @param {*} request
 * @param {*} response
 */
async function GetSpecialEventDeviceDataFixed(request, response) {
  try {
    ...
    var Device_data = await SpecialEventModel.getSpecialEventDetailFixed(
      Cust_id,
      Bill_id
    );
...
/**
 * Get Special Event Data for ToU Plan
 * @param {*} request
 * @param {*} response
 */
async function GetSpecialEventDeviceDataTOU(request, response) {
  try {
    ...
    var Device_data = await SpecialEventModel.getSpecialEventDetailTOU(
      Cust_id,
      Bill_id
    );
