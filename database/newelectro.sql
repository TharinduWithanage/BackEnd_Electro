...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2021 at 08:44 AM
...
(1002, 'Tharindu', 'perera', 'buthsaramadhushanka@gmail.com', '$2b$10$ArvIXD20Joo.PMx71jFGlOJWDwqtZmJzsydMlk501CF/K.y2PY7rS', 'customer'),
...
(1, 'Tharidu', 'Withana', 'admin1@gmail.com', '0145467892', '$2b$10$43uMOMFsIfTp764xipnO3.wK9n4xv4M.ZZEm4FZjAmarGjKiql3oK', '68745123v', 'Matara', '2021-07-21', 'admin'),
...
INSERT INTO `fixed_ucharge` (`Unit_category`, `Unit_charge`, `Fixed_charge`) VALUES
('0-30', 2.5, 30),
('0-60', 7.85, 0),
('121-180', 32, 480),
('31-60', 4.85, 60),
...
INSERT INTO `tou_ucharge` (`Time_category`, `Unit_charge`, `Fixed_charge`) VALUES
('Day', 25, 540),
('Off Peak', 13, 540),
('Peak', 54, 540);
...
ALTER TABLE `electric_device_mplan`
  ADD PRIMARY KEY (`Device_id`,`Bill_id`),
  ADD KEY `FK3` (`Bill_id`),
  ADD KEY `FK4` (`Cust_id`);
...
--
ALTER TABLE `customer`
  MODIFY `Cust_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1004;
...
--
ALTER TABLE `electric_device_mplan`
  ADD CONSTRAINT `FK3` FOREIGN KEY (`Bill_id`) REFERENCES `ebill_specialevent` (`Bill_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK4` FOREIGN KEY (`Cust_id`) REFERENCES `customer` (`Cust_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK5` FOREIGN KEY (`Bill_id`) REFERENCES `ebill_monthly_plan` (`Bill_id`) ON DELETE CASCADE ON UPDATE CASCADE;
