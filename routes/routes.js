...
router
  ...
  .put(authService.validateToken, userProfileController.profileUpdate);

//user profile  route
router
  .route("/user-profile/:id")
  .get(authService.validateToken, userProfileController.profileGetData);

//unit charges route
router
  .route("/unit-charges/:id")
  .get(authService.validateToken, unitChargesController.getUnitChargesData);

//unit charges update route
router
  .route("/unit-charges-update/:id")
  .post(authService.validateToken, unitChargesController.updateUnitChargesData);

//accepted unit charges update route
router
  .route("/accepted-unit-charges-update/:id")
  .post(
    authService.validateToken,
    unitChargesController.acceptedUnitChargesUpdate
  );

//reject unit charges update admin route
router
  .route("/reject-unit-charges-update/:id")
  .post(
    authService.validateToken,
    unitChargesController.rejectUnitChargesUpdate
  );

//add new ceb engineer route
router
  .route("/add-cebengineer")
  .post(authService.validateToken, userRegisterController.addNewCebEngineer);

//get ceb engineer route
router
  .route("/manager-cebengineer")
  .get(authService.validateToken, userRegisterController.getCebEngineer);

//remove ceb engineer route
router
  .route("/remove-cebengineer/:id")
  .get(authService.validateToken, userRegisterController.removeCebEngineer);
...
// //add device data
router
  .route("/add-device-main-bill/:id")
  .post(authService.validateToken, monthlyBillCalculate.AddDeviceDataMain);

// //Update device data
router
  .route("/update-device-main-bill/:id")
  .post(authService.validateToken, monthlyBillCalculate.updateDeviceDataMain);

// //delete device data
router
  .route("/delete-device-main-bill/:id")
  .post(authService.validateToken, monthlyBillCalculate.deleteDeviceDataMain);

// get devices for bill whitch currently working in front end
router
  .route("/get-device-main-bill/:id")
  .post(authService.validateToken, monthlyBillCalculate.getDeviceDataMain);
...
router
  .route("/get-bill-id/:id")
  .get(authService.validateToken, monthlyBillCalculate.getBillId);

//get Special Event Bill id for front end Fixed
router
  .route("/get-special-event-fix-bill-id/:id")
  .get(
    authService.validateToken,
...
router
  ...
  .get(authService.validateToken, specialEventTOUBillCalculate.getTOUBillId);

//calculate the main bill
router
  .route("/calculate-main-bill/:id")
  .post(authService.validateToken, calculation.calculatedBillValue);

//calculate the main bill
router
  .route("/calculate-special-event-TOUbill/:id")
  .post(
    authService.validateToken,
    specialEventTOUBillCalculate.calculatedTOUBillValue
  );

//calculate the main bill
router
  .route("/save-special-event-TOUbill/:id")
  .post(
    authService.validateToken,
    specialEventTOUBillCalculate.saveTOUBillValue
  );
...
router
  .route("/get-device-wise-usage-tou-main/:id")
  .post(authService.validateToken, deviceWiseController.getTouDeviceWise);

//add special event device data
router
  .route("/add-device-special-Fixedbill/:id")
  .post(
    authService.validateToken,
    specialEventFixedBillCalculate.AddSpecialEventDeviceDataFixed
  );

//add special event device data
router
  .route("/add-device-special-TOUbill/:id")
  .post(
    authService.validateToken,
    specialEventTOUBillCalculate.AddSpecialEventDeviceDataTOU
  );

//Get Spceial event fixed all details
router
  .route("/get-specialEvent-fixedDetails/:id")
  .post(
    authService.validateToken,
    specialEventFixedBillCalculate.GetSpecialEventDeviceDataFixed
  );

//Get Spceial event fixed all details
router
  .route("/get-specialEvent-TOUDetails/:id")
  .post(
    authService.validateToken,
    specialEventTOUBillCalculate.GetSpecialEventDeviceDataTOU
  );

// //Update special event  device data
router
  .route("/update-device-special-Fixedbill/:id")
  .post(
    authService.validateToken,
    specialEventFixedBillCalculate.updateDeviceDataSpecialEvent
  );

// //Update special event  device data
router
  .route("/update-device-special-TOUbill/:id")
  .post(
    authService.validateToken,
    specialEventTOUBillCalculate.updateDeviceDataSpecialEventTOU
  );

// //delete special event device data in fixed model
router
  .route("/delete-device-special-Fixedbill/:id")
  .post(
    authService.validateToken,
    specialEventFixedBillCalculate.deleteSpecialEventDeviceData
  );

// //delete special event device data in tou
router
  .route("/delete-device-special-TOUbill/:id")
  .post(
    authService.validateToken,
    specialEventTOUBillCalculate.deleteSpecialEventDeviceData
  );

//calculate the main bill
router
  .route("/get-calculated-main-bill/:id")
  .post(authService.validateToken, calculation.getcalculatedBillValue);

//get device wise usage fixed main
router
  .route("/get-device-wise-usage-fixed-main/:id")
  .post(authService.validateToken, deviceWiseController.getFixedDeviceWise);
...
router
  ...
  .post(authService.validateToken, billPlanController.deleteMonthlyBillPlans);
